...
const certifications = [
  ...
  },
  {
    ...
    issuer: 'Ethical Hacking',
    status: 'Completed',
    color: '#FF9900',
    icon: '🔒',
  },
  {
    title: 'Connected Systems & IoT',
...
const achievements = [
  {
    title: 'Zomathon Data Hackathon',
    org: 'Coding Ninjas × Eternal/Zomato',
    year: '2024',
    description: 'Participated in a data hackathon, applying analytical thinking and collaborative problem-solving to real-world data challenges.',
    icon: '📊',
  },
  {
    ...
    org: 'GetWork.ai',
    year: '2025',
    description: 'Developed and deployed an AI-powered Full Stack Application under strict project timelines.',
    icon: '⚡',
  },
  {
    ...
    org: 'GitHub',
    year: 'Ongoing',
    description: 'Maintains an active GitHub Portfolio with 6+ full-stack projects, showcasing clean code practices, version control, and API design.',
    icon: '⬡',
  },
  {
    title: 'Accessible UI Implementations',
    org: 'WCAG 2.1 Standards',
    year: 'Ongoing',
    description: 'Designed accessible and responsive web interfaces following WCAG 2.1 standards to improve usability and user experience.',
    icon: '👁',
  },
];
