...
const projects: Project[] = [
  {
    ...
    description: 'A production-style Full Stack Event Booking Platform supporting organizers and customers through secure role-based workflows.',
    story: [
      {
        chapter: 'Chapter I — The Architecture',
        title: 'Building for Scale',
        content: 'Developed a scalable REST API using Flask and integrated MongoDB for efficient data management, forming the backbone of the platform.',
      },
      {
        chapter: 'Chapter II — The Frontend',
        title: 'Designing User Experiences',
        content: 'Designed responsive and accessible user interfaces using React.js and Figma, ensuring a seamless experience for both organizers and customers.',
      },
      {
        chapter: 'Chapter III — The Security',
        title: 'Role-Based Access Control',
        content: 'Implemented secure Role-Based Access Control (RBAC) to manage user permissions and protect organizer functionalities, ensuring data integrity.',
      },
    ],
    problem: 'Event organizers lacked a unified, secure platform with role-based workflows for booking and capacity monitoring.',
    solution: 'Built a real-time organizer dashboard and robust backend using Flask, MongoDB, and React.js with RBAC implementation.',
    result: 'Delivered a highly reliable, accessible platform with optimized application reliability and documented SDLC practices.',
    tags: ['React.js', 'Flask', 'MongoDB', 'RBAC', 'REST API'],
    image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87',
    imageAlt: 'Large event or concert with crowd',
    year: '2025',
  },
  {
    id: 'ecommerce',
    ...
    subtitle: 'Checkout Workflow',
    description: 'A Microservices-Based E-Commerce Checkout System using Node.js, Express.js, MySQL, and RabbitMQ for asynchronous communication.',
    story: [
      {
        chapter: 'Chapter I — The Challenge',
        title: 'Scaling the Checkout',
        content: 'Traditional monolithic checkouts struggle under heavy load. The goal was to build a fault-tolerant, scalable system for high-volume transactions.',
      },
      {
        chapter: 'Chapter II — The Build',
        title: 'Microservices & Queues',
        content: 'Implemented asynchronous communication using RabbitMQ and developed modular REST APIs for payment, inventory, cart, and discount management.',
      },
      {
        chapter: 'Chapter III — The Result',
        title: 'Fault-Tolerant Operations',
        content: 'Optimized database interactions and backend workflows. The multi-step React checkout interface provided real-time feedback and responsive validation.',
      },
    ],
    problem: 'High-volume e-commerce transactions require fault-tolerant, scalable checkout systems that do not drop orders during traffic spikes.',
    solution: 'Developed a microservices-based system using Node.js, Express, MySQL, and RabbitMQ for asynchronous communication.',
    result: 'Improved scalability and transaction efficiency through modular APIs and rigorous API testing and validation.',
    tags: ['Node.js', 'RabbitMQ', 'Microservices', 'MySQL', 'React.js'],
    image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d',
    imageAlt: 'E-commerce digital payment concept',
    year: '2024',
  },
  {
    id: 'flightpredictor',
    ...
    description: 'A machine learning web application predicting flight ticket prices using Python and supervised learning techniques.',
    story: [
      {
        chapter: 'Chapter I — The Problem',
        title: 'The Unpredictable Sky',
        content: 'Airline ticket prices fluctuate wildly. Travelers had no reliable way to know when to book, often overpaying or missing optimal windows.',
      },
      {
        chapter: 'Chapter II — The Build',
        title: 'Training the Machine',
        content: 'Trained a machine learning model on historical flight data. Implemented REST APIs connecting machine learning predictions with a responsive frontend.',
      },
      {
        chapter: 'Chapter III — The Impact',
        title: 'Smarter Decisions',
        content: 'Enhanced application usability through interactive result visualization and error handling, following WCAG 2.1 accessibility standards.',
      },
    ],
    problem: 'Airline ticket prices fluctuate unpredictably, making it difficult for travelers to book at the optimal time.',
    solution: 'Trained a machine learning model using supervised learning techniques, deployed with an interactive web interface.',
    result: 'Optimized user interaction through progressive data entry and real-time prediction feedback for reliable cost estimation.',
    tags: ['Python', 'Machine Learning', 'JavaScript', 'REST API'],
    image: 'https://images.unsplash.com/photo-1512162940654-a2b6874174d3',
    imageAlt: 'Aerial view of airplane wing above clouds',
    year: '2024',
  },
];
